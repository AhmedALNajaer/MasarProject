...
// const CourseList = ({ videos, selectedVideo, onSelectVideo }) => {
//   return (
...
//         <hr className="my-2 border-blue-900 border-1" />
//       </div>
        ...
        <ul>
          {videos.map((video, index) => (
            <li
              ...
              className={`cursor-pointer mb-3 p-2 rounded-lg hover:bg-blue-100 ${
